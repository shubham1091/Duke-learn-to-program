...
public class Tester {
    ...
    public static void testLogAnalyzer() {
        ...
        lg.readFile("data/log/short-test_log");
        lg.printAll();
    }

    public static void testUniqIP() {
        LogAnalyzer la = new LogAnalyzer();
        la.readFile("data/log/weblog2_log");
    ...
    public static void testStatusCode() {
        LogAnalyzer la = new LogAnalyzer();
        la.readFile("data/log/weblog1_log");
    ...
    public static void testUni() {
        LogAnalyzer la = new LogAnalyzer();
        la.readFile("data/log/short-test_log");
    ...
    public static void testIPsForDays() {
        ...
        analyzer.readFile("data/log/weblog3-short_log");
